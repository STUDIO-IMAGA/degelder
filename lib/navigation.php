...
function toggler( $theme_location = 'primary_navigation' ){
  ...
  $html .= '<span class="navbar-toggler-text">Menu</span>';
  $html .= '</button>';
...
function navigation_list( $theme_location = "theme_location", $menu_id = "menu_id", $menu_class = "nav flex-column menu_class"){
  return wp_nav_menu(
    array(
      'theme_location'    => $theme_location,
      'container'         => FALSE,
