...
<div class="container">
  <div class="row align-items-start">
    ...
    <? if( $layout['fact_3']['post'] ): ?>

      <? $post = $layout['fact_3']['post']; setup_postdata($post); $image = get_field('image', $post->ID); $color = $layout['fact_3']['color']; ?>
  ...
  <div class="row align-items-start">
    ...
    <? if( $layout['fact_4']['post'] ): ?>

      <? $post = $layout['fact_4']['post']; setup_postdata($post); $image = get_field('image', $post->ID); $color = $layout['fact_4']['color']; ?>
    ...
    <? if( $layout['fact_5']['post'] ): ?>

      <? $post = $layout['fact_5']['post']; setup_postdata($post); $image = get_field('image', $post->ID); $color = $layout['fact_5']['color']; ?>
